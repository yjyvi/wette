...
/**
 * Created by yonghao zeng on 2017/4/23.
 */
public class DividerGridItemDecoration extends RecyclerView.ItemDecoration
{
   ...
   // private static final int[] ATTRS = new int[] { android.R.attr.listDivider };
    ...
    public DividerGridItemDecoration(Context context, int resourId)
    {
        mDivider = ContextCompat.getDrawable(context,resourId);
                               ...
                               RecyclerView parent)
    {
       ...
       /* if ((itemPosition + 1) % 2!= 0) {
        ...
        outRect.set(0,0, outRect.right,outRect.bottom);*/
