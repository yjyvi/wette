...
public class DateUtils {
    ...
    /**
     * 日期String 转 YYYYMMDD 类型String
     * @param str
     * @param format
     * @return
     */
    public static String string2YYYYMMDD(String str,String format){
        return string2String(str,format,YYYY_MM_DD);
    }

    /**
     *  YYYY_MM_DD_HH_MM_SS 类型的日期字符串 转 YYYY MM DD 类型的日期字符串
     * @param str
     * @return
     */
    public static String string2YYYYMMDD(String str){
        return string2YYYYMMDD(str,YYYY_MM_DD_HH_MM_SS);
    }
    ...
    public static String getTimestampString(long time) {
        long splitTime = getTimeSplit(time);
     ...
     * @return
     */
    public static long getTimeSplit(Long l){
        Date curDate = new Date();
        long splitTime = curDate.getTime()-l;
        return splitTime;
    }
